...
# print(f'Ordenação dentro da coluna e linha : \n{m_col_lin}')
###

# 5 - Agora vamos preparar alguns "ndarray" para serem representados por gráficos:
...
# # Numpy já possui métodos diretos de como salvar um arquivo no formato .txt
...
# 6 - Agora podemos utilizar uma das várias bibliotecas para plotar gráficos, foi escolhido plotly
